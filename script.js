...
const drone = new ScaleDrone("3SXr1lTmBZwvptwC");
...
function startWebRTC(isOfferer) {
  ...
  navigator.mediaDevices
    ...
    .then((stream) => {
      localStream = stream; // Set the acquired stream to localStream
  ...
  function toggleVideo() {
    ...
    // Show/hide video and placeholder image based on video state
    if (isVideoEnabled) {
    ...
    document.getElementById('videoButton').textContent = isVideoEnabled ? "Turn Off Video" : "Turn On Video";
  }
